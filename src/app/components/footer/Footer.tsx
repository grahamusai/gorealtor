...
<footer className="bg-blue-100/80 mt-8 font-sans dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        ...
        <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2023 You Limaz Properties Inc. All rights reserved.</p>
    </div>
</footer>
    )
};
